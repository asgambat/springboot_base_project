...
public class PaymentService {
	...
	public PaymentService(MeterRegistry registry) {
		this.paymentTimer = Timer.builder("payments.latency").description("Payment processing latency")
				.publishPercentiles(0.5, 0.95, 0.99) // p50, p95, p99
				.publishPercentileHistogram().tag("service", "payments").register(registry);
	}
